      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 mb-8 md:mb-0 animate-fade-in">
          ...
          <a 
            ...
            className="inline-block bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold px-8 py-4 rounded-full shadow-lg hover:shadow-hover transition-all duration-300 transform hover:-translate-y-1 text-lg"
          >
        ...
        <div className="w-full md:w-1/2 flex justify-center animate-slide-up">
          <img 
            ...
            className="rounded-2xl shadow-xl max-w-full h-auto object-cover transform hover:scale-105 transition-transform duration-300"
